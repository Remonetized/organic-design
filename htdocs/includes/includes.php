    ...
    <div class="modal modal-small" id="loginModal">
        <div class="modal-content">
            ...
            <div class="modal-header">                    
                ...
                <span class="close ms-auto" onclick="closeModal('loginModal')">&times;</span>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="button button-red cancel" onclick="closeModal('loginModal')">Cancel</button>
            </div>
            <div class="modal-footer">
                <span>Or <a class="loginButton" id="registerAnchor" onclick="registerModal()">register</a> a new account</span>
            </div>
        </div>
    </div>
</form>
...
<form method="post" enctype="multipart/form-data">
    <div class="modal modal-small" id="registerModal">
        <div class="modal-content">    
        <!-- Modal Header -->
        <div class="modal-header">
            <div class="modalTitle">Register</div>
            <span class="close ms-auto" onclick="closeModal('registerModal')">&times;</span>
        </div>
        <!-- Modal body -->
        <div class="modal-body">
            <div class="form-input">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="button button-red cancel" onclick="closeModal('registerModal')">Cancel</button>
        </div>
        <div class="modal-footer">
            <span>Already registered? <a class="loginButton" id="loginAnchor" onclick="loginModal()">Login</a></span>
        </div>
...
<!-- Shop Item Modal -->
<div class="modal modal-large" id="cartModal">
    <div class="modal-content">
        <div class="modal-header">
            <div class="modalTitle">Your Cart</div>
            <span class="close ms-auto" onclick="closeModal('cartModal')">&times;</span>
        </div>
        <div class="modal-body">
            <img class="bg-transparent border-dark shadow-none" id="shopImg">
            <div class="text-white pt-3 px-4" id="shopCaption"></div>
        </div>
        <div class="modal-footer py-1">
            <button type="submit" class="button button-blue" name="confirmBtn" onclick="location.href='checkout.php'">Go to Checkout</button>
            <button class="button button-red" id="modalCloseBottom" onclick="closeModal('cartModal')">Close</button>
        </div>
    </div>
</div>
<!-- End of Shop Item Modal -->
